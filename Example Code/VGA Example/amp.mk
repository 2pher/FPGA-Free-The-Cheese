...
# Files
HDRS		:= nios2_ctrl_reg_macros.h address_map_nios2.h
SRCS		:= video_interrupt.c exception_handler.c globals.c interval_timer_ISR.c amp/lib/src/niosII_jtag_uart.c
...
# Files
SYS_FILE_SOF			:= "C:/intelFPGA_lite/18.0/University_Program/Computer_Systems/DE1-SoC/DE1-SoC_Computer/verilog/DE1_SoC_Computer.sof"
SYS_SCRIPT_JTAG_ID		:= --script="C:/intelFPGA_lite/18.0/University_Program/Monitor_Program/bin/jtag_instance_check.tcl"
SYS_FILE_ARM_PL			:= --preloader "C:/intelFPGA_lite/18.0/University_Program/Monitor_Program/arm_tools/u-boot-spl.de1-soc.srec"
SYS_FLAG_ARM_PL_ADDR	:= --preloaderaddr 0xffff13a0

############################################
# Compilation Targets

COMPILE: video_interrupt.srec

video_interrupt.srec: video_interrupt.elf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@

video_interrupt.elf: $(OBJS)
	$(RM) $@
	$(CC) $(OBJS) $(LDFLAGS) -o $@
...
CLEAN: 
	$(RM) video_interrupt.srec video_interrupt.elf $(OBJS)
