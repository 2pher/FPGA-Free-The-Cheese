...
SRCS		:= PS2_interrupt.c PS2_ISR.c exception_handler.c globals.c interval_timer_ISR.c amp/lib/src/niosII_jtag_uart.c
...
COMPILE: PS2_interrupt.srec

PS2_interrupt.srec: PS2_interrupt.elf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@

PS2_interrupt.elf: $(OBJS)
	$(RM) $@
	$(CC) $(OBJS) $(LDFLAGS) -o $@
...
CLEAN: 
	$(RM) PS2_interrupt.srec PS2_interrupt.elf $(OBJS)
